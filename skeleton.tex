...
\ShortTitle{Summary of Working Group 4}

\author{\speaker{Alessandro Gaz}\\
        Nagoya\\
        E-mail: \email{gaz@hepl.phys.nagoya-u.ac.jp}}
\author{
        Vladimir V. Gligorov\\%\thanks{I would like to thank my mum, dad, and trade union representative for their support. Couldn't have done it without you!}\\
...
\author{
        Dean Robinson\\%\thanks{Show me an ambulance dashing off into the night, and I shall show you the theorists bravely in pursuit.}\\
...
\abstract{We summarize the new results on $B$ meson mixing and mixing-related $CP$ violation presented at CKM2016.
We place these results in the context of both previous experimental measurements and the most recent theoretical developments
in the field, and discuss prospects for ongoing and future mixing and mixing-related $CP$ violation measurements.}
